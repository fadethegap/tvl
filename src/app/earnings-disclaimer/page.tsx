        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
            <div className="mx-auto text-center flex flex-col gap-3">
              <h1 className="text-2xl">Earnings Disclaimer</h1>
              <h3 className="">
                No Earnings Projections, Promises Or Representations
              </h3>
            </div>

            <p className="text-center">Effective Date: May, 2018</p>
            <div className="flex flex-col gap-5 mt-10">
              ...
              <p>
                ...
                using our product, ideas, and techniques. We do not position
                this product as a “get rich scheme.”
              </p>
              <p>
              ...
              <p>
                ...
                guarantees are made that you will achieve any results from our
              ...
              <p>
                ...
                or guarantees whatsoever to you about future prospects or
                earnings, or that you will earn any money, with respect to your
                purchase of Paul Xavier’s products, and that we have not
                authorized any such projection, promise, or representation by
                others.
              </p>
              <p>
                ...
                the entire risk of not doing as well as the information
              ...
              <p>
                ...
                credits, whether convertible to cash or not) will apply, nor can
                any prior successes be used, as an indication of your future
                success or results from any of the information, content, or
                strategies. Any and all claims or representations as to income
                or earnings (whether monetary or advertising credits, whether
                convertible to cash or not) are not to be considered as “average
                earnings”.
              </p>
              <p>
                (i) The Economy. The economy, both where you do business, and on
                a national and even worldwide scale, creates additional
                uncertainty and economic risk. An economic recession or
                depression might negatively affect the results produced by Paul
                Xavier’s products.
              </p>
              <p>
                ...
                work ethic, your dedication, your motivation, your desire, or
                your business skills or practices. Therefore, we do not
                guarantee or imply that you will get rich, that you will do as
                well, or that you will have any earnings (whether monetary or
                advertising credits, whether convertible to cash or not), at
                all.
              </p>
              <p>
                ...
                purchase Paul Xavier’s products, and/or any monies spent setting
                up, operating, and/or marketing Paul Xavier’s products, and
                further, that you may have no earnings at all (whether monetary
                or advertising credits, whether convertible to cash or not).
              </p>
              <p>
              ...
              <p>
                ...
                YOU WILL ACHIEVE RESULTS SIMILAR TO OURS OR ANYBODY ELSE, IN
                FACT NO GUARANTEES ARE MADE THAT YOU WILL ACHIEVE ANY RESULTS
                FROM OUR IDEAS AND TECHNIQUES IN OUR MATERIAL.
              </p>
              <p>
                (iv) Due Diligence. You are advised to do your own due diligence
                when it comes to making business decisions and should use
                caution and seek the advice of qualified professionals. You
                should check with your accountant, lawyer, or professional
                advisor, before acting on this or any information. You may not
                consider any examples, documents, or other content on the
                website or otherwise provided by us to be the equivalent of
                professional advice. Nothing contained on the website or in
                ...
                accountant, lawyer, or professional advisor for any questions
                you may have.
              </p>
              <p>
              ...
              <p>
                ...
                purchase price for Paul Xavier’s products has been arbitrarily
